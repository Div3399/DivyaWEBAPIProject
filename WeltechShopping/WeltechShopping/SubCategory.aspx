<%@ Page Title="SubCategory | Admin" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="SubCategory.aspx.cs" Inherits="WeltechShopping.SubCategory" %>
                    ...
                    <div class="card card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtSubCatName" runat="server" CssClass="form-control" placeholder="Enter Subcategory Name"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                            ...
                                            <asp:GridView ID="GVDisplay" runat="server" CssClass="table table-bordered" AutoGenerateColumns="false" OnRowCommand="GVDisplay_RowCommand" PageSize="10" AllowPaging="true" OnPageIndexChanging="GVDisplay_PageIndexChanging">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Subcategory Id">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblCategoryId" runat="server" CssClass="form-label" Text='<%#Eval("SubCatId") %>'>
                                                            </asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Subcategory Name">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblSubCatName" runat="server" CssClass="form-label" Text='<%#Eval("SubCatName") %>'>
                                                            </asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Action">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="btnEdit" runat="server" CssClass="btn btn-sm btn-info m-1" ToolTip="Edit" Text="Edit" role="Button" CommandArgument='<%#Eval("SubCatId") %>' CommandName="EditSubCategory"><i class="fa fa-edit"></i> </asp:LinkButton>
                                                            <asp:LinkButton ID="btnDelete" runat="server" ToolTip="Delete" Text="Delete" CssClass="btn btn-sm btn-danger" CommandArgument='<%#Eval("SubCatId") %>' CommandName="DeleteSubCategory">
